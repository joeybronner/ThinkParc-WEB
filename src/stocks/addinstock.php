...
?>
   ...
   <body>
	...
	?>
         ...
         <img src="../../images/background/stocks/think-parc-addinstock.jpg" id="menu-img" class="main-img inactive" alt="FCT Partners">
                  ...
                  <div class="panel-body">
                     <div class="row">
                        <div class="col-md-12 col-lg-12">
                           <form id="addinstock" class="formimg" name="form1" action="javascript:addinstock();" method="post" enctype="multipart/form-data">
                              <table class="table-no-border">
                                 <tbody>
                                    <tr>
                                       <td>
                                          <h5>* <?php echo $stocks['REFERENCE'];?></h5></td>
                                    </tr>
                                    <tr>
                                       <td>


                                          <input type="text" id="ref" placeholder="<?php echo $stocks['REFERENCE'];?>" onkeyup="checkref(ref, fct_id_company);" class="form-control" required/>
                                       </td>
                                       <td>
                                    ...
                                    <tr>
                                       <td>
                                          <h5>* <?php echo $stocks['QUANTITYANDMEASURE'];?></h5></td>
                                    </tr>
                                    <tr>
                                       <td>
                                    ...
                                    <tr>
                                       <td>
                                          <h5>* <?php echo $stocks['LOCATION'];?></h5></td>
                                    </tr>
                                    <tr>
                                       <td>
                                    ...
                                    <tr>
                                       <td>
                                          <h5><?php echo $stocks['LOCATIONANDTYPE'];?></h5></td>
                                    </tr>
                                    <tr>
                                       <td>
                                    ...
                                    <tr>
                                       <td>
                                          <h5>* <?php echo $stocks['ASSIGNMENTANDSTOREHOUSE'];?></h5></td>
                                    </tr>
                                    <tr>
                                       <td>
