...
function getFamily() {
   $.ajax({
      ...
      success: function(data) {
         ...
         var content = '<option selected disabled>Family</option>';
...
function getUnderFamily(id_family) {
   ...
   $.ajax({
      ...
      success: function(data) {
         var response = JSON.parse(data);
         var content = '<option selected disabled>Underfamily</option>';
...
function getUnderFamily2(id_family) {
   ...
   $.ajax({
      ...
      success: function(data) {
         var response = JSON.parse(data);
         var content = '<option selected disabled>Under family 2</option>';
         for (var i = 0; i < response.length; i++) {
            content = content + '<option value="' + response[i].id_family + '">' + response[i].family + '</option>';
         }
...
function addProduct() {
   ...
   buyingprice = ChangeComma(buyingprice);
