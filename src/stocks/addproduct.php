...
?>
   ...
   <body>
	...
	?>
         ...
         <!-- Hidden input for JS values -->
         <input type="hidden" id="fct_id_company" value="<?php echo $_SESSION['fct_id_company'];?>" />
                  ...
                  <div class="panel-body">
                     <div class="row">
                        <div class="col-md-12 col-lg-12">
                           <form id="addproduct" class="formimg" action="javascript:addProduct();" method="post" enctype="multipart/form-data">
                              <table class="table-no-border">
                                 <tbody>
                                    <tr>
                                       <td>
                                          <h5>* <?php echo $stocks['FAMILY'];?></h5></td>
                                    </tr>
                                    <tr>
                                       <td class="small">
                                    ...
                                    <tr>
                                       <td>
                                          <h5>* <?php echo $stocks['PRICE'];?></h5></td>
                                    </tr>
                                    <tr>
                                       <td>
                                    ...
                                    <tr>
                                       <td>
                                          <h5><?php echo $stocks['BRANDANDCOM'];?></h5></td>
                                    </tr>
                                    <tr>
                                       <td>
