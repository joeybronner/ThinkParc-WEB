                              ...
                              <div class="col-md-12 col-lg-12">
                                 <form>
                                    <table class="table-no-border">
                                       <tr>
                                          <td>
                                             <h5><?php echo $stocks['SELECTTRANSFER'];?></h5></td>
                                       </tr>
                                       <tr>
                                          <td>
                                             ...
                                             <select id="transfertlist" class="form-control" onchange="getalltransferts(fct_id_user, this.value);">
                                 ...
                                 <div class="col-md-12 col-lg-12">
                                    <form>
                                       <div class="col-md-12 col-lg-12">
                                          ...
                                          <a href="javascript:receptioncheck();" class="btn btn-success">
                                             <?php echo $stocks['RECEIVE'];?>
                                          </a>
                                       </div>
                                    </form>
                                 </div>
