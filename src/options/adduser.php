...
?>
   ...
   <head>
      ...
      <?php
		...
		echo '<script type="text/javascript" src="adduser.js"></script>';
	?>
   ...
   <body>
      ...
      <?php require(BASE_PATH . '/src/header/navbar.php'); ?>
         ...
         <div id="fct_id_user" style="display: none;">
            <?php echo $_SESSION['fct_id_user']; ?>
         </div>

         <!-- Background image for this page-->
         <img src="../../images/background/options/think-parc-adduser.jpg" id="menu-img" class="main-img inactive" alt="FCT Partners"/>
                  ...
                  <div class="panel-body">
                     <div class="row">
                        <div class="col-md-12 col-lg-12">
                           <form id="adduser" class="formimg" action="javascript:adduser(firstname, lastname, login, password, email, image, id_role, id_company);" method="post" enctype="multipart/form-data">
                              <table class="table-no-border">
                                 <tbody>
                                    <tr>
                                       <td>
                                          <h5>*<?php echo $options['FIRSTNAMEANDLASTNAME'];?></h5></td>
                                    </tr>
                                    <tr>
                                       <td>
                                    ...
                                    <tr>
                                       <td>
                                          <h5>*<?php echo $options['LOGINANDEMAIL'];?></h5></td>
                                    </tr>
                                    <tr>
                                       <td>
                                    ...
                                    <tr>
                                       <td>
                                          <h5>*<?php echo $options['PASSWORDTITLE'];?></h5></td>
                                    </tr>
                                    <tr>
                                       <td>
                                    ...
                                    <tr>
                                       <td>
                                          <h5>* <?php echo $options['COMPANYANDROLE'];?></h5></td>
                                    </tr>
                                    <tr>
                                       <td>
                                    ...
                                    <tr>
                                       <td>
                                          <h5><?php echo $options['PICTURE'];?></h5></td>
                                    </tr>
                                    <tr>
