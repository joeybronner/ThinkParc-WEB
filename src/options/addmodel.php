...
?>
   ...
   <head>
      ...
      <?php
		...
		echo '<script type="text/javascript" src="addmodel.js"></script>';
	?>
   ...
   <body>
      ...
      <?php require(BASE_PATH . '/src/header/navbar.php'); ?>
         ...
         <img src="../../images/background/options/think-parc-addmodel.jpg" id="menu-img" class="main-img inactive" alt="FCT Partners">
         ...
         <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad">
            ...
            <div class="templatemo-content">
               <div class="black-bg btn-menu margin-bottom-20">
                  <h2><?php echo $options['TITLE_ADDMODEL'];?></h2>
                  <div class="panel-body">
                     <div class="row">
                        <div class="col-md-12 col-lg-12">
                           <form id="addmodel" class="formimg" action="javascript:addmodel(id_brand, model);" method="post" enctype="multipart/form-data">
