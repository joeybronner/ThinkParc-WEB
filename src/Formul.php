...
<form class="formoid-solid-dark" style="background-color:#7d7d7d;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#005500;max-width:480px;min-width:150px" method="get" action="EnregistrementVehicule.php"><div class="title"><h2>Enregistrer une machine</h2></div>
	...
	<div class="element-select"><div class="item-cont"><span><select name="marque" class="medium" >
...
<?php 
	...
	?>
		...
		<div class="element-select"><div class="item-cont"><span><select name="genre" class="medium" >
		...
		</select></span><i></i><span class="icon-place"></span><span><select name="categorie" class="medium" >
	...
	<div class="element-select"><label class="title"><span class="required">*</span></label><div class="item-cont"><div class="large"><span><select name="energie" required="required" class="medium">
	...
	<div class="element-date" title="date"><label class="title"><span class="required">* Date</span></label><div class="item-cont"><input class="medium" data-format="yyyy-mm-dd" type="date" name="date" required="required" placeholder=" Date" class="medium"/><span class="icon-place"></span></div></div>
	
	<div class="element-input" title="matricule"><label class="title"></label><div class="item-cont"><input class="medium" type="text" name="matricule" placeholder="Matricule"/><input class="medium" type="text" name="numerodeserie" placeholder="Numéro de série"/><span class="icon-place"></span></div></div>

	<div class="element-date"><label class="title"><span class="required">*</span></label><div class="item-cont"><input class="medium" data-format="yyyy-mm-dd" type="date" name="dateachat" required="required" placeholder="Date d’Achat " class="medium"/><input class="medium" data-format="yyyy-mm-dd" type="date" name="misecirculation" placeholder="Date de Mise en Route"/>    <span class="icon-place"></span></div></div>

	<div class="element-input"><label class="title"><span class="required">*</span></label><div class="item-cont"><input class="medium" type="text" name="kilometrage" required="required" placeholder="Compteur "/><span class="icon-place"></span></div></div>
	...
	<div class="element-select"><label class="title"><span class="required">*</span></label><div class="item-cont"><div class="medium"><span><select name="affectation" required="required">
