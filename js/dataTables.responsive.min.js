...
(function(n, p) {
   var o = function(e, k) {
      ...
      h.prototype = {
         _constructor: function() {
            ...
            this.c.breakpoints.sort(function(a, d) {
               return a.width < d.width ? 1 : a.width > d.width ? -1 : 0
            });
            this._classLogic();
            this._resizeAuto();
         ...
         _classLogic: function() {
            ...
            c.each(function(b, d) {
               for (var c = b.className.split(" "), j = !1, h = 0, k = c.length; h < k; h++) {
                  var l = e.trim(c[h]);
                  if ("all" === l) {
                     j = !0;
                  ...
                  e.each(a, function(a, b) {
                     var c = b.name.split("-"),
                        e = l.match(RegExp("(min\\-|max\\-|not\\-)?(" + c[0] + ")(\\-[_a-zA-Z0-9])?"));
                     e && (j = !0, e[2] === c[0] && e[3] === "-" + c[1] ? g(d, b.name, e[1], e[2] + e[3]) : e[2] === c[0] && !e[3] && g(d, b.name, e[1], e[2]))
                  })
               }
               j || (b.auto = !0)
            });
   ...
   "function" === typeof define && define.amd ? define(["jquery", "datatables"], o) : "object" === typeof exports ? o(require("jquery"), require("datatables")) : jQuery && !jQuery.fn.dataTable.Responsive && o(jQuery, jQuery.fn.dataTable)
})(window, document);