...
class Validate {
	...
	public static function minNum ( $val, $data, $opts ) {
		$numeric = Validate::numeric( $val, $data, $opts );
		if ( $numeric !== true ) {
			return $numeric;
		}
	...
	public static function minMaxNum ( $val, $data, $opts ) {
		...
		$min = Validate::minNum( $val, $data, $opts );
		if ( $min !== true ) {
			return $min;
		}

		return Validate::maxNum( $val, $data, $opts );
	}
	...
	public static function minMaxLen( $val, $data, $opts ) {
		$min = Validate::minLen( $val, $data, $opts );
		if ( $min === true ) {
			return Validate::maxLen( $val, $data, $opts );
		}
		return $min;
	}
