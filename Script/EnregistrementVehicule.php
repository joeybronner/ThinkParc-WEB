   ...
   <style type="text/css">
	...
	<div class="madiv">
		...
		<?php
			...
			if(!empty($_GET['marque']) && !empty($_GET['modele']) && !empty($_GET['misecirculation']) && !empty($_GET['kilometrage']) 
			&& !empty($_GET['energie']) && !empty($_GET['nom']) && !empty($_GET['prenom']) && !empty($_GET['cartegrise']) && !empty($_GET['chevaux']) )
			{
			$dbh->RecordCar();
